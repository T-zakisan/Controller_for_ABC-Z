...
from Config import PosiAll                  #ABC-Zのボタン[一括]位置の読み込み
from Config import PosiFilter               #ABC-Zのボタン[フィルタ]位置の読み込み
from Config import Zoom                     #Zoom使用時のカーソル移動
from Config import Disply                   #ディスプレイサイズの読み込み
